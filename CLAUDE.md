...
- **Adding a person:** in-app — Fair Nine → Family — or via `cloud.addMember(email)` from any app. Instant; no rules deploy needed. Rules deploys are only for changing the rules *logic*.
